...
const OutrosJogos = () => {
    const games = React.useMemo(//“memorizar” o componentes? q vai ser criado, pra n render toda vez
        () => [
            {
                id: 1,
  ...
  return (
    <div id="outros_jogos" className="container w-75 my-5">
        <h2 className="text-uppercase text-center text-md-start ms-md-5 ps-md-3 mb-4 text-white">
            Outros Jogos
        </h2>
        <div id="itens_jogos" className="d-flex flex-column ms-md-5 ps-md-3 gap-4">
            {games.map((item) => (
